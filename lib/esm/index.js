...
const isNan = (obj) => isNaN(obj);
const isString = (obj) => isType(obj) === 'string';
const isNumber = (obj) => isType(obj) === 'number' && isNaN(obj) === false;
...
const isBase64 = (str) => isString(str) && str.indexOf('base64') >= 0 && str.indexOf('data:') === 0;
const isEmptyObject = (obj) => isObject(obj) ? Object.keys(obj).length === 0 : false;
const isEmptyArray = (obj) => isArray(obj) ? obj.length === 0 : false;
